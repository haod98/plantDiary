    ...
    <HomepageLayout>
        <div class="my-5">
            ...
            <h1 class="text-xl font-bold uppercase">
                Privacy Policy for PlantDiary
            </h1>
            <p>
                At PlantDiary, accessible from haodev.de, one of our main
                priorities is the privacy of our visitors. This Privacy Policy
                document contains types of information that is collected and
                recorded by PlantDiary and how we use it.
            </p>
            <p>
            ...
            <p>
                ...
                information that they shared and/or collect in PlantDiary. This
            ...
            <h2 class="text-lg font-semibold">Consent</h2>
            <p>
            ...
            <p>
                PlantDiary follows a standard procedure of using log files.
            ...
            <h2 class="text-lg font-semibold">Cookies and Web Beacons</h2>
            <p>
                Like any other website, PlantDiary uses 'cookies'. These cookies
            ...
            <P
                ...
                of the advertising partners of PlantDiary.</P
            >
            <p>
                Third-party ad servers or ad networks uses technologies like
                cookies, JavaScript, or Web Beacons that are used in their
                respective advertisements and links that appear on PlantDiary,
            ...
            <p>
                Note that PlantDiary has no access to or control over these
                cookies that are used by third-party advertisers.
            </p>
            <h2 class="text-lg font-semibold">Third Party Privacy Policies</h2>
            <p>
                PlantDiary's Privacy Policy does not apply to other advertisers
            ...
            <h2 class="text-lg font-semibold">GDPR Data Protection Rights</h2>
            <p>
            ...
            <h2 class="text-lg font-semibold">Children's Information</h2>
            <p>
            ...
            <p>
                PlantDiary does not knowingly collect any Personal Identifiable
