...
<template>
    <HomepageLayout>
        <div class="my-5">
            <p class="text-center text-xl font-bold uppercase text-red-500">
                Important: This is just a dummy website for an university
                project. Once the assignment is over this website will be
                offline.
            </p>
            <div class="text-center">
                <a
                    class="text-center text-lg text-blue-400"
                    href="https://github.com/haod98/plantDiary"
                    >The source code</a
                >
            </div>
            ...
            <p>
                ...
                webpage shall manage your use of our website, PlantDiary
                accessible at haodev.de.
            </p>
            <p>
            ...
            <h2 class="text-lg font-semibold">Intellectual Property Rights</h2>
            <p>
                Other than the content you own, under these Terms, PlantDiary
            ...
            <p>
                ...
                by you and PlantDiary may further restrict access by you to any
            ...
            <p>
                ...
                you grant PlantDiary a non-exclusive, worldwide irrevocable, sub
            ...
            <p>
                ...
                third-party’s rights. PlantDiary reserves the right to remove
                any of Your Content from this Website at any time without
                notice.
            </p>
            <h2 class="text-lg font-semibold">Your Privacy</h2>
            <p>Please read Privacy Policy.</p>
            <h2 class="text-lg font-semibold">No warranties</h2>
            <p>
                This Website is provided "as is," with all faults, and
                PlantDiary express no representations or warranties, of any kind
            ...
            <p>
                In no event shall PlantDiary, nor any of its officers, directors
                ...
                such liability is under contract. PlantDiary, including its
            ...
            <p>
                You hereby indemnify to the fullest extent PlantDiary from and
            ...
            <h2 class="text-lg font-semibold">Severability</h2>
            <p>
                If any provision of these Terms is found to be invalid under any
                applicable law, such provisions shall be deleted without
                affecting the remaining provisions herein.
            </p>
            <h2 class="text-lg font-semibold">Variation of Terms</h2>
            <p>
                PlantDiary is permitted to revise these Terms at any time as it
                sees fit, and by using this Website you are expected to review
                these Terms on a regular basis.
            </p>
            <h2 class="text-lg font-semibold">Assignment</h2>
            <p>
                The PlantDiary is allowed to assign, transfer, and subcontract
            ...
            <h2 class="text-lg font-semibold">Entire Agreement</h2>
            <p>
                These Terms constitute the entire agreement between PlantDiary
                and you in relation to your use of this Website, and supersede
                all prior agreements and understandings.
            </p>
            <h2 class="text-lg font-semibold">Governing Law & Jurisdiction</h2>
            <p>
